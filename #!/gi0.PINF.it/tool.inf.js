...
// console.error("MOCHA BUILD:", build, target, instance, home);
            ...
            if (instance.api === 'expect/v1') {
                ...
                if (build.config.wait) {
                    ...
                    LIB.console.info(`Wait for all test suites '${Object.keys(reports).join(',')}' to finish.`);
...
// console.log("[gi0.PINF.it/build/v0] load component():", NS);

    return {

        invoke: async function (pointer, value, options) {

// console.log("[gi0.PINF.it/build/v0] invoke():", pointer, value);

            if (pointer === 'onHome()') {

// console.log('setup onHome INSTRUCTIONS');

                runHomeInstructions = async function () {

// console.log('!!!!!! RUN HOME INSTRUCTIONS!:', value);
